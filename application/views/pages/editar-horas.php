					...
					<div class="col-md-12">
						...
						<form action="<?= base_url('banco-horas/' . $bancoHoras->id); ?>" method="post">
							...
							<div class="input-group mb-2">
								...
								<input type="time" class="form-control" id="start" name="start" placeholder="Início" value="<?= $bancoHoras->start; ?>">
							</div>
							...
							<div class="input-group mb-2">
								...
								<input type="time" class="form-control" id="pause" name="pause" placeholder="Saída para Almoço" value="<?= $bancoHoras->pause; ?>">
							</div>
							...
							<div class="input-group mb-2">
								...
								<input type="time" class="form-control" id="return" name="return" placeholder="Volta do Almoço" value="<?= $bancoHoras->return; ?>">
							</div>
							...
							<div class="input-group mb-2">
								...
								<input type="time" class="form-control" id="finish" name="finish" placeholder="Encerramento" value="<?= $bancoHoras->finish; ?>">
							</div>
