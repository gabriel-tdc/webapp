			...
			<div class="card">
				<div class="row align-items-center">
					<div class="col-md-12">
						...
						<form action="<?= base_url('banco-horas'); ?>" method="post">
							...
							<div class="input-group mb-2">
								...
								<input type="time" class="form-control" id="pause" name="pause" placeholder="Saída para Almoço">
							</div>
							...
							<div class="input-group mb-2">
								...
								<input type="time" class="form-control" id="return" name="return" placeholder="Volta do Almoço">
							</div>
							...
							<div class="input-group mb-2">
								...
								<input type="time" class="form-control" id="finish" name="finish" placeholder="Encerramento">
							</div>
